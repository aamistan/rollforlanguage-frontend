<template>
  <div class="flex flex-col gap-4">
    <button
      ...
      :key="tool.name"
      class="flex items-center gap-2 px-4 py-2 bg-rose-50 text-rose-900 hover:bg-rose-100 dark:bg-rose-900 dark:text-rose-100 dark:hover:bg-rose-800 rounded text-left"
